...
/**
 * Created by orz on 2016/8/13.
 */
class SPFUtil private constructor() {
    ...
    fun putString(key: String, value: String): SPFUtil {
        editor.putString(key, value)
        editor.commit()
        return this
    }

    fun putInt(key: String, value: Int): SPFUtil {
        editor.putInt(key, value)
        editor.commit()
        return this
    }

    fun putFloat(key: String, value: Float): SPFUtil {
        editor.putFloat(key, value)
        editor.commit()
        return this
    }

    fun putLong(key: String, value: Long): SPFUtil {
        editor.putLong(key, value)
        editor.commit()
        return this
    }

    fun putBoolean(key: String, value: Boolean): SPFUtil {
    ...
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    fun putStringSet(key: String, value: Set<String>): SPFUtil {
    ...
    fun remove(key: String): SPFUtil {
        editor.remove(key)
        editor.commit()
        return this
    }

    fun removeAll(): SPFUtil {
        editor.clear()
        editor.commit()
        return this
    }
